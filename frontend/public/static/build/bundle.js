var app = (function () {
    ...
    const file$4 = "src/views/Login.svelte";
    ...
    const file$3 = "src/layouts/AuthLayout.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 3, 2, 53);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label_1, "class", "svelte-1ca07lk");
    			add_location(label_1, file$2, 25, 15, 691);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			span.textContent = "*";
    			attr_dev(span, "class", "svelte-1ca07lk");
    			add_location(span, file$2, 26, 27, 737);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(/*help*/ ctx[6]);
    			attr_dev(div, "class", "help svelte-1ca07lk");
    			add_location(div, file$2, 29, 6, 807);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(/*error*/ ctx[7]);
    			attr_dev(div, "class", "error svelte-1ca07lk");
    			add_location(div, file$2, 32, 6, 870);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			input = element("input");
    			attr_dev(div0, "class", "top svelte-1ca07lk");
    			add_location(div0, file$2, 24, 2, 658);
    			...
    			attr_dev(input, "class", "svelte-1ca07lk");
    			add_location(input, file$2, 35, 2, 924);
    			attr_dev(div1, "class", "input svelte-1ca07lk");
    			toggle_class(div1, "focused", /*focused*/ ctx[9]);
    			toggle_class(div1, "error", !!/*error*/ ctx[7]);
    			add_location(div1, file$2, 20, 0, 594);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['name', 'placeholder', 'type', 'value', 'label', 'required', 'help', 'error'];
    ...
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(15:29) <Link to={paths.LOGIN}>",
    		ctx
    	});
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 13, 2, 324);
    			attr_dev(p, "class", "svelte-1p5fzce");
    			add_location(p, file$1, 14, 2, 343);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Link: Link$1, AuthLayout, Input, paths, formData });
    	return [formData];
    }
