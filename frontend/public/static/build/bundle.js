var app = (function () {
    ...
    const file$4 = "src/layouts/AuthLayout.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			if (default_slot) default_slot.c();
    			attr_dev(div0, "class", "card svelte-1u9v3h6");
    			add_location(div0, file$4, 3, 2, 53);
    			attr_dev(div1, "class", "wrapper svelte-1u9v3h6");
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label_1, "class", "svelte-eoneld");
    			add_location(label_1, file$3, 31, 15, 811);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			span.textContent = "*";
    			attr_dev(span, "class", "svelte-eoneld");
    			add_location(span, file$3, 32, 27, 857);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(/*help*/ ctx[6]);
    			attr_dev(div, "class", "help svelte-eoneld");
    			add_location(div, file$3, 35, 6, 927);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(/*error*/ ctx[7]);
    			attr_dev(div, "class", "error svelte-eoneld");
    			add_location(div, file$3, 38, 6, 990);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_fragment$3(ctx) {
    	...
    	let if_block1 = /*help*/ ctx[6] && !/*error*/ ctx[7] && create_if_block_1(ctx);
    	let if_block2 = /*error*/ ctx[7] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			input = element("input");
    			attr_dev(div0, "class", "top svelte-eoneld");
    			add_location(div0, file$3, 30, 2, 778);
    			...
    			attr_dev(input, "class", "svelte-eoneld");
    			add_location(input, file$3, 41, 2, 1044);
    			attr_dev(div1, "class", "input svelte-eoneld");
    			toggle_class(div1, "focused", /*focused*/ ctx[9]);
    			toggle_class(div1, "error", !!/*error*/ ctx[7]);
    			add_location(div1, file$3, 26, 0, 714);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 41, 0, 955);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot_2$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(21:31) <Link to={paths.LOGIN}>",
    		ctx
    	});
    ...
    // (26:4) <Button color={Color.primary}>
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(26:4) <Button color={Color.primary}>",
    		ctx
    	});
    ...
    function create_default_slot$1(ctx) {
    	...
    	input3 = new Input({
    			props: {
    				...
    				placeholder: "safetaters69",
    				value: /*formData*/ ctx[0].confirmPassword,
    	...
    	const block = {
    		c: function create() {
    			...
    			form = element("form");
    			p = element("p");
    			t2 = text("Already got an account? ");
    			...
    			attr_dev(h1, "class", "svelte-1p5fzce");
    			add_location(h1, file$1, 18, 2, 478);
    			attr_dev(p, "class", "svelte-1p5fzce");
    			add_location(p, file$1, 20, 4, 548);
    			add_location(form, file$1, 19, 2, 497);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
