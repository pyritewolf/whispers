var app = (function () {
    ...
    // (53:4) <Link to={paths.PASSWORD_RECOVERY}>
    function create_default_slot_2$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(53:4) <Link to={paths.PASSWORD_RECOVERY}>",
    		ctx
    	});
    ...
    // (69:4) <Button color={Color.primary}>
    function create_default_slot_1$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(69:4) <Button color={Color.primary}>",
    		ctx
    	});
    ...
    function create_default_slot$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 49, 2, 1836);
    			attr_dev(p, "class", "svelte-bwd7l6");
    			add_location(p, file$4, 50, 2, 1855);
    			add_location(form, file$4, 54, 2, 1955);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*formError*/ 2) input1_changes.error = getErrorFor('auth', /*formError*/ ctx[1]);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	return [formData, formError, handleSubmit, input0_value_binding, input1_value_binding];
    }
    ...
    class Icon extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { name: 0, size: 1, color: 2 });
