var app = (function () {
    ...
    const file$2 = "src/views/Home.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file, 9, 2, 227);
    			add_location(div, file, 13, 2, 305);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router: Router$1, Link: Link$1, Route: Route$1, Home, Login, name });
