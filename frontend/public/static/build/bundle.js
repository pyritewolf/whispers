var app = (function () {
  ...
  var user = writable(JSON.parse(localStorage.getItem("user")) || null);
  ...
  function create_fragment$6(ctx) {
    ...
    let if_block1 =
      /*help*/ ctx[6] && !(/*error*/ ctx[7]) && create_if_block_1$2(ctx);
    let if_block2 = /*error*/ ctx[7] && create_if_block$3(ctx);
    ...
    const block = {
      c: function create() {
        ...
        attr_dev(
          ...
          "class",
          (button_class_value =
            "" + (null_to_empty(/*size*/ ctx[3]) + " svelte-1bfrfc8"))
        );
        button.disabled = /*disabled*/ ctx[4];
        toggle_class(button, "disabled", /*disabled*/ ctx[4]);
        toggle_class(button, "focused", /*focused*/ ctx[6]);
        add_location(button, file$5, 50, 0, 1080);
      },
      l: function claim(nodes) {
        throw new Error(
          "options.hydrate only works if the component was compiled with the `hydratable: true` option"
        ...
        if (!mounted) {
          dispose = [
            listen_dev(
              ...
              "click",
              function () {
                if (is_function(/*click*/ ctx[5]))
                  /*click*/ ctx[5].apply(this, arguments);
              },
              false,
              false,
              false
      ...
      p: function update(new_ctx, [dirty]) {
        ...
        if (dirty & /*size, disabled*/ 24) {
          toggle_class(button, "disabled", /*disabled*/ ctx[4]);
        }

        if (dirty & /*size, focused*/ 72) {
          toggle_class(button, "focused", /*focused*/ ctx[6]);
        }
      },
      i: function intro(local) {
  ...
  function instance$5($$self, $$props, $$invalidate) {
    ...
    const focus_handler = () => $$invalidate(6, (focused = true));
    const blur_handler = () => $$invalidate(6, (focused = false));
  ...
  // (57:4) <Link to={paths.PASSWORD_RECOVERY}>
  function create_default_slot_2$3(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "slot",
      source: "(57:4) <Link to={paths.PASSWORD_RECOVERY}>",
      ctx,
    });
  ...
  // (73:4) <Button color={Color.primary}>
  function create_default_slot_1$3(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "slot",
      source: "(73:4) <Button color={Color.primary}>",
      ctx,
    });
  ...
  function create_default_slot$3(ctx) {
    ...
    let input1_props = {
      ...
      error: getErrorFor("auth", /*formError*/ ctx[1]),
      name: "password",
    };
    ...
    const block = {
      c: function create() {
        ...
        add_location(h1, file$4, 53, 2, 2005);
        attr_dev(p, "class", "svelte-bwd7l6");
        add_location(p, file$4, 54, 2, 2024);
        add_location(form, file$4, 58, 2, 2124);
      },
      m: function mount(target, anchor) {
        insert_dev(target, h1, anchor);
        insert_dev(target, t1, anchor);
      ...
      p: function update(ctx, dirty) {
        ...
        if (dirty & /*formError*/ 2)
          input1_changes.error = getErrorFor("auth", /*formError*/ ctx[1]);
  ...
  function create_catch_block(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(p0, file$2, 74, 4, 2429);
        attr_dev(h1, "class", "svelte-gkby9");
        add_location(h1, file$2, 77, 4, 2508);
        attr_dev(p1, "class", "svelte-gkby9");
        add_location(p1, file$2, 79, 4, 2538);
        attr_dev(p2, "class", "svelte-gkby9");
        add_location(p2, file$2, 80, 4, 2571);
      },
      m: function mount(target, anchor) {
  ...
  function create_else_block$1(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        t7 = text("\n        if you've already got an account.");
        attr_dev(p0, "class", "svelte-gkby9");
        add_location(p0, file$2, 61, 6, 2039);
        attr_dev(h1, "class", "svelte-gkby9");
        add_location(h1, file$2, 64, 6, 2124);
        attr_dev(p1, "class", "svelte-gkby9");
        add_location(p1, file$2, 65, 6, 2144);
        attr_dev(p2, "class", "svelte-gkby9");
        add_location(p2, file$2, 66, 6, 2195);
      },
      m: function mount(target, anchor) {
        insert_dev(target, p0, anchor);
        mount_component(icon, p0, null);
  ...
  function create_default_slot_3$1(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "slot",
      source: "(70:8) <Link to={paths.SIGN_IN}>",
      ctx,
    });
  ...
  function create_default_slot_1$2(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "slot",
      source: "(57:8) <Link to={paths.SIGN_IN}>",
      ctx,
    });
  ...
  // (58:2) {#if current_status === status.SUBMITTED}
  function create_if_block_1$1(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(p0, file$1, 58, 4, 2003);
        attr_dev(p1, "class", "svelte-bwd7l6");
        add_location(p1, file$1, 61, 4, 2099);
      },
      m: function mount(target, anchor) {
        insert_dev(target, p0, anchor);
        mount_component(icon, p0, null);
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: "(58:2) {#if current_status === status.SUBMITTED}",
      ctx,
    });
  ...
  function create_default_slot_2$1(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "slot",
      source: "(69:4) <Link to={paths.SIGN_IN}>",
      ctx,
    });
  ...
  // (71:2) {#if current_status !== status.SUBMITTED}
  function create_if_block$1(ctx) {
    ...
    button = new Button({
      props: {
        color: Color.primary,
        disabled: /*current_status*/ ctx[2] === /*status*/ ctx[3].LOADING,
    ...
    const block = {
      c: function create() {
        ...
        t3 = space();
        create_component(button.$$.fragment);
        add_location(form, file$1, 71, 4, 2348);
      },
      m: function mount(target, anchor) {
        insert_dev(target, form, anchor);
        mount_component(input0, form, null);
        ...
        if (!mounted) {
          dispose = listen_dev(
            form,
            "submit",
            prevent_default(/*handleSubmit*/ ctx[4]),
            false,
            true,
            false
          );
      ...
      p: function update(ctx, dirty) {
        ...
        const button_changes = {};
        if (dirty & /*current_status*/ 4)
          button_changes.disabled =
            /*current_status*/ ctx[2] === /*status*/ ctx[3].LOADING;
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: "(71:2) {#if current_status !== status.SUBMITTED}",
      ctx,
    });
  ...
  // (100:6) <Button         color={Color.primary}         disabled={current_status === status.LOADING}>
  ...
  function create_default_slot$1(ctx) {
    ...
    let current;
    let if_block0 =
      /*current_status*/ ctx[2] === /*status*/ ctx[3].SUBMITTED &&
    ...
    const block = {
      c: function create() {
        ...
        attr_dev(h1, "class", "svelte-bwd7l6");
        add_location(h1, file$1, 56, 2, 1938);
        attr_dev(p, "class", "svelte-bwd7l6");
        add_location(p, file$1, 66, 2, 2217);
      },
      m: function mount(target, anchor) {
        insert_dev(target, h1, anchor);
        insert_dev(target, t1, anchor);
      ...
      p: function update(ctx, dirty) {
        if (/*current_status*/ ctx[2] === /*status*/ ctx[3].SUBMITTED) {
          if (if_block0) {
            if_block0.p(ctx, dirty);
  ...
  function create_fragment$1(ctx) {
    ...
    const block = {
      ...
      p: function update(ctx, [dirty]) {
        ...
        if (dirty & /*$$scope, current_status, formError, formData*/ 2055) {
          authlayout_changes.$$scope = { dirty, ctx };
        }
  ...
  function instance$1($$self, $$props, $$invalidate) {
    ...
    const handleSubmit = () =>
      __awaiter(void 0, void 0, void 0, function* () {
        $$invalidate(2, (current_status = status.LOADING));
        ...
        if (response.status === APIStatus.error)
          return $$invalidate(1, (formError = response.body));
        $$invalidate(1, (formError = null));
        $$invalidate(2, (current_status = status.SUBMITTED));
      });
    ...
    $$self.$inject_state = ($$props) => {
      ...
      if ("formError" in $$props)
        $$invalidate(1, (formError = $$props.formError));
      if ("current_status" in $$props)
        $$invalidate(2, (current_status = $$props.current_status));
    };
  ...
  function create_default_slot_4(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "slot",
      source: "(21:8) <Link to={paths.SIGN_IN}>",
      ctx,
    });
  ...
  function create_default_slot_3(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "slot",
      source: "(22:8) <Link to={paths.REGISTER}>",
      ctx,
    });
  ...
  function create_default_slot_2(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "slot",
      source: "(19:8) <Link to={paths.HOME}>",
      ctx,
    });
  ...
  function create_default_slot_1(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "slot",
      source: "(27:8) <Route path={paths.HOME}>",
      ctx,
    });
  ...
  function create_default_slot(ctx) {
    ...
    current_block_type_index = select_block_type(ctx);
    if_block0 = if_blocks[current_block_type_index] = if_block_creators[
      current_block_type_index
    ](ctx);
    ...
    if_block1 = if_blocks_1[current_block_type_index_1] = if_block_creators_1[
      current_block_type_index_1
    ](ctx);
    ...
    const block = {
      c: function create() {
        ...
        div = element("div");
        if_block1.c();
        add_location(nav, file, 16, 4, 421);
        add_location(div, file, 24, 4, 626);
      },
      m: function mount(target, anchor) {
  ...
  function create_fragment(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        t3 = space();
        create_component(router.$$.fragment);
        add_location(h1, file, 14, 2, 383);
        add_location(main, file, 13, 0, 374);
      },
      l: function claim(nodes) {
        throw new Error(
          "options.hydrate only works if the component was compiled with the `hydratable: true` option"
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    component_subscribe($$self, user, ($$value) =>
